...
const LandingSection: React.FC = () => {
  const openGoogleForm = () => {
    window.open(constants.formLink, '_blank');
  };
  ...
  return (
    <section id="home" className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white min-h-screen flex items-center relative overflow-hidden pt-16">
      <div className="absolute inset-0 z-0">
        ...
        >
          <source src={constants.videoUrl} type="video/mp4" />
