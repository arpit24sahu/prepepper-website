      ...
      <section id="home" className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white min-h-screen flex items-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4 animate-fade-in-up">
            <small className="block text-xl sm:text-2xl mb-2" style={{ WebkitTextStroke: '1px black' }}>Build on your</small>
            <span className="text-4xl sm:text-5xl md:text-6xl" style={{ WebkitTextStroke: '1px black' }}>Million Dollar Idea!</span>
          </h2>
          <p className="text-xl sm:text-2xl mb-8 animate-fade-in-up delay-200" style={{ WebkitTextStroke: '0.5px black' }}>
